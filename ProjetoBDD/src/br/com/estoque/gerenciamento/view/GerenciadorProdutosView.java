...
public class GerenciadorProdutosView extends JFrame {
    ...
    private JButton btnSalvar, btnDeletar, btnListar, btnLimpar, btnVoltar;
    private JTable tabela;
    private DefaultTableModel modelo;
    private GerenciadorController controller;

    public GerenciadorProdutosView(GerenciadorController controller) {
    ...
    private void salvarProduto() {
        ...
        // Verificar se o idCategoria existe na tabela categorias
        if (!controller.categoriaExiste(idCategoria)) {
            JOptionPane.showMessageDialog(this, "ID de Categoria inválido! Verifique se a categoria existe.");
            return;
        }
    ...
    private void listarProdutos() {
        ...
        for (Produtos produto : produtos) {
            modelo.addRow(new Object[]{produto.getIdProduto(), produto.getNome(), produto.getDescricao(), produto.getQuantidade(), produto.getPrecoCompra(), produto.getPrecoVenda(), produto.getIdCategoria()});
        }
    }
